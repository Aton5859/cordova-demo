(function (intellisense) {
    ...
    angular.module('ng').config(['$injector', '$provide', function ($injector, $provide) {
        ...
        $provide.decorator("$http", ['$delegate', function ($delegate) {
            ...
            * @property {Object.<string|Object>} params  每 Map of strings or objects which will be turned
            *      to `?key1=value1&key2=value2` after the url. If the value is not a string, it will be
            *      JSONified.
            * @property {string|Object} data  每 Data to be sent as the request message data.
            * @property {Object} headers  每 Map of strings or functions which return strings representing
            *      HTTP headers to send to the server. If the return value of a function is null, the
            *      header will not be sent.
            * @property {string} xsrfHeaderName  每 Name of HTTP header to populate with the XSRF token.
            * @property {string} xsrfCookieName  每 Name of cookie containing the XSRF token.
            * @property {function(data, headersGetter)|Array.<function(data, headersGetter)>} transformRequest  每
            *      transform function or an array of such functions. The transform function takes the http
            *      request body and headers and returns its transformed (typically serialized) version.
            * @property {function(data, headersGetter)|Array.<function(data, headersGetter)>} transformResponse  每
            *      transform function or an array of such functions. The transform function takes the http
            *      response body and headers and returns its transformed (typically deserialized) version.
            * @property {boolean|Cache} cache  每 If true, a default $http cache will be used to cache the
            *      GET request, otherwise if a cache instance built with
            *      {@link ng.$cacheFactory $cacheFactory}, this cache will be used for
            *      caching.
            * @property {number|Promise} timeout  每 timeout in milliseconds, or {@link ng.$q promise}
